...
bool ATJNetworkingTerrain::Configure(const FTJNetworkStrategyConfig& NewConfig){ Config=NewConfig; ConstructionAlpha=1.0f; BuildLAN(); BuildTor(); FTJNetworkGateway G; G.GatewayId=TEXT("default"); G.Hostname=TEXT("gateway"); G.Location=FVector(7200,0,0); BuildClearnet(G); TArray<FTJVPNPeer> Empty; BuildVPN(Empty); return true; }
